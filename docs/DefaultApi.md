...
------------- | ------------- | -------------
[**get_version**](DefaultApi.md#get_version) | **GET** /info/version | Gets the version of the Pure Fusion control plane.

# **get_version**
> Version get_version(x_request_id=x_request_id, authorization=authorization, x_correlation_id=x_correlation_id)
...
api_instance = fusion.DefaultApi(fusion.ApiClient(configuration))
...
try:
    # Gets the version of the Pure Fusion control plane.
    api_response = api_instance.get_version(x_request_id=x_request_id, authorization=authorization, x_correlation_id=x_correlation_id)
    pprint(api_response)
