...
class StorageEndpointCbsAzureIscsiPost(object):
    ...
    def __init__(self, storage_endpoint_collection_identity=None, load_balancer=None, load_balancer_addresses=None):  # noqa: E501
        """StorageEndpointCbsAzureIscsiPost - a model defined in Swagger"""  # noqa: E501
    ...
    def storage_endpoint_collection_identity(self):
        """Gets the storage_endpoint_collection_identity of this StorageEndpointCbsAzureIscsiPost.  # noqa: E501

        The Storage Endpoint Collection Identity which belongs to the Azure entities.  # noqa: E501

        :return: The storage_endpoint_collection_identity of this StorageEndpointCbsAzureIscsiPost.  # noqa: E501
        :rtype: str
        """
    ...
    def storage_endpoint_collection_identity(self, storage_endpoint_collection_identity):
        """Sets the storage_endpoint_collection_identity of this StorageEndpointCbsAzureIscsiPost.

        The Storage Endpoint Collection Identity which belongs to the Azure entities.  # noqa: E501

        :param storage_endpoint_collection_identity: The storage_endpoint_collection_identity of this StorageEndpointCbsAzureIscsiPost.  # noqa: E501
        :type: str
        """
    ...
    def load_balancer(self):
        """Gets the load_balancer of this StorageEndpointCbsAzureIscsiPost.  # noqa: E501

        The Load Balancer id which gives permissions to CBS array appliations to modify the Load Balancer.  # noqa: E501

        :return: The load_balancer of this StorageEndpointCbsAzureIscsiPost.  # noqa: E501
        :rtype: str
        """
    ...
    def load_balancer(self, load_balancer):
        """Sets the load_balancer of this StorageEndpointCbsAzureIscsiPost.

        The Load Balancer id which gives permissions to CBS array appliations to modify the Load Balancer.  # noqa: E501

        :param load_balancer: The load_balancer of this StorageEndpointCbsAzureIscsiPost.  # noqa: E501
        :type: str
        """
    ...
    def load_balancer_addresses(self):
        """Gets the load_balancer_addresses of this StorageEndpointCbsAzureIscsiPost.  # noqa: E501


        :return: The load_balancer_addresses of this StorageEndpointCbsAzureIscsiPost.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def load_balancer_addresses(self, load_balancer_addresses):
        """Sets the load_balancer_addresses of this StorageEndpointCbsAzureIscsiPost.


        :param load_balancer_addresses: The load_balancer_addresses of this StorageEndpointCbsAzureIscsiPost.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageEndpointCbsAzureIscsiPost, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageEndpointCbsAzureIscsiPost):
            return False
