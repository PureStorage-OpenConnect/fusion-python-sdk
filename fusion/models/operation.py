...
class Operation(object):
    ...
    def __init__(self, id=None, self_link=None, request=None, request_type=None, request_id=None, request_collection=None, state=None, result=None, status=None, retry_in=None, error=None, created_at=None, started_at=None, ended_at=None, cancelation=None, update_fields=None):  # noqa: E501
    ...
    @property
    def started_at(self):
        """Gets the started_at of this Operation.  # noqa: E501

        The time that the operation was admitted, in milliseconds since the Unix epoch.  # noqa: E501

        :return: The started_at of this Operation.  # noqa: E501
        :rtype: int
        """
    ...
    def started_at(self, started_at):
        """Sets the started_at of this Operation.

        The time that the operation was admitted, in milliseconds since the Unix epoch.  # noqa: E501

        :param started_at: The started_at of this Operation.  # noqa: E501
        :type: int
        """
    ...
    @property
    def ended_at(self):
        """Gets the ended_at of this Operation.  # noqa: E501

        The time that the operation ended with status Succeeded or Failed, in milliseconds since the Unix epoch.  # noqa: E501

        :return: The ended_at of this Operation.  # noqa: E501
        :rtype: int
        """
    ...
    def ended_at(self, ended_at):
        """Sets the ended_at of this Operation.

        The time that the operation ended with status Succeeded or Failed, in milliseconds since the Unix epoch.  # noqa: E501

        :param ended_at: The ended_at of this Operation.  # noqa: E501
        :type: int
        """
        if ended_at is None:
    ...
    def cancelation(self):
        """Gets the cancelation of this Operation.  # noqa: E501

        The cancelation status of the operation, one of five values. CancelNone means no cancelation has been requested or occured. CancelRequested means the user or system has requested to cancel the operation; it may or may not happen. CancelInProgress means the system has accepted the request to cancel and is trying to do so; once an operation is in Canceling status, it will fail. CancelSuccessful means an operation has failed with a CANCELED error code. CancelUnsuccessful means cancel was requested, but the system could not cancel the operation -- it may have failed with an error code other than CANCELED; or it may have succeeded.  # noqa: E501

        :return: The cancelation of this Operation.  # noqa: E501
        :rtype: str
        """
        return self._cancelation

    @cancelation.setter
    def cancelation(self, cancelation):
        """Sets the cancelation of this Operation.

        The cancelation status of the operation, one of five values. CancelNone means no cancelation has been requested or occured. CancelRequested means the user or system has requested to cancel the operation; it may or may not happen. CancelInProgress means the system has accepted the request to cancel and is trying to do so; once an operation is in Canceling status, it will fail. CancelSuccessful means an operation has failed with a CANCELED error code. CancelUnsuccessful means cancel was requested, but the system could not cancel the operation -- it may have failed with an error code other than CANCELED; or it may have succeeded.  # noqa: E501

        :param cancelation: The cancelation of this Operation.  # noqa: E501
        :type: str
        """
        if cancelation is None:
            raise ValueError("Invalid value for `cancelation`, must not be `None`")  # noqa: E501
        allowed_values = ["CancelNone", "CancelRequested", "CancelInProgress", "CancelSuccessful", "CancelUnsuccessful"]  # noqa: E501
        if cancelation not in allowed_values:
            raise ValueError(
                "Invalid value for `cancelation` ({0}), must be one of {1}"  # noqa: E501
                .format(cancelation, allowed_values)
            )

        self._cancelation = cancelation

    @property
    def update_fields(self):
        """Gets the update_fields of this Operation.  # noqa: E501

        Key/value pairs of the fields this operation is updating, if it is an Update operation. E.g. destroyed:true or size:1048576.  # noqa: E501

        :return: The update_fields of this Operation.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def update_fields(self, update_fields):
        """Sets the update_fields of this Operation.

        Key/value pairs of the fields this operation is updating, if it is an Update operation. E.g. destroyed:true or size:1048576.  # noqa: E501

        :param update_fields: The update_fields of this Operation.  # noqa: E501
        :type: dict(str, str)
        """
