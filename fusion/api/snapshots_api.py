...
class SnapshotsApi(object):
    ...
    def list_snapshots_with_http_info(self, tenant_name, tenant_space_name, **kwargs):  # noqa: E501
        ...
        all_params = ['tenant_name', 'tenant_space_name', 'x_request_id', 'authorization', 'x_correlation_id', 'filter', 'sort', 'limit', 'offset', 'id', 'name', 'display_name', 'protection_policy_id', 'destroyed', 'time_remaining', 'volume', 'placement_group']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def query_snapshots(self, **kwargs):  # noqa: E501
        """Get all Snapshots in the org. Provide a filter to search for specific snapshots.  # noqa: E501
