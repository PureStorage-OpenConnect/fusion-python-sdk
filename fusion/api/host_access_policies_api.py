...
class HostAccessPoliciesApi(object):
    ...
    def update_host_access_policy(self, body, host_access_policy_name, **kwargs):  # noqa: E501
        """Updates a Host Access Policy.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_host_access_policy(body, host_access_policy_name, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param HostAccessPolicyPatch body: (required)
        :param str host_access_policy_name: The Host policy name (required)
        :param str x_request_id: The Request ID supplied with the request, used to perform operations idempotently.
        :param str authorization: Access token (in JWT format) required to use any API endpoint.
        :param str x_correlation_id: The Correlation ID provided will be added to log messages and can be used for support. The same Correlation ID may be used for separate requests, to track a higher level workflow.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_host_access_policy_with_http_info(body, host_access_policy_name, **kwargs)  # noqa: E501
        else:
            (data) = self.update_host_access_policy_with_http_info(body, host_access_policy_name, **kwargs)  # noqa: E501
            return data

    def update_host_access_policy_with_http_info(self, body, host_access_policy_name, **kwargs):  # noqa: E501
        """Updates a Host Access Policy.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_host_access_policy_with_http_info(body, host_access_policy_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'host_access_policy_name', 'x_request_id', 'authorization', 'x_correlation_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_host_access_policy" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_host_access_policy`")  # noqa: E501
        # verify the required parameter 'host_access_policy_name' is set
        if ('host_access_policy_name' not in params or
                params['host_access_policy_name'] is None):
            raise ValueError("Missing the required parameter `host_access_policy_name` when calling `update_host_access_policy`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/host-access-policies/{host_access_policy_name}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
