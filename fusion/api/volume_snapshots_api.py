...
class VolumeSnapshotsApi(object):
    ...
    def query_volume_snapshots(self, **kwargs):  # noqa: E501
        """Get all Volume Snapshots in the org. Provide a filter to search for specific volume snapshots.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_volume_snapshots(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.query_volume_snapshots_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.query_volume_snapshots_with_http_info(**kwargs)  # noqa: E501
            return data

    def query_volume_snapshots_with_http_info(self, **kwargs):  # noqa: E501
        """Get all Volume Snapshots in the org. Provide a filter to search for specific volume snapshots.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_volume_snapshots_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['filter', 'sort', 'limit', 'offset', 'id', 'name', 'display_name', 'tenant_space_id', 'tenant_id', 'destroyed', 'snapshot_id', 'volume_id', 'time_remaining', 'volume_serial_number', 'placement_group_id', 'protection_policy_id', 'created_at', 'x_request_id', 'authorization', 'x_correlation_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method query_volume_snapshots" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/resources/volume-snapshots', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
