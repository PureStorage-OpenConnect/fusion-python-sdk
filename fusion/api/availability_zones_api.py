...
class AvailabilityZonesApi(object):
    ...
    def get_availability_zone_performance(self, region_name, availability_zone_name, **kwargs):  # noqa: E501
        """(Provider) Gets performance metrics of a specific Availability Zone.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_availability_zone_performance(region_name, availability_zone_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_availability_zone_performance_with_http_info(region_name, availability_zone_name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_availability_zone_performance_with_http_info(region_name, availability_zone_name, **kwargs)  # noqa: E501
            return data

    def get_availability_zone_performance_with_http_info(self, region_name, availability_zone_name, **kwargs):  # noqa: E501
        """(Provider) Gets performance metrics of a specific Availability Zone.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_availability_zone_performance" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'region_name' is set
        if ('region_name' not in params or
                params['region_name'] is None):
            raise ValueError("Missing the required parameter `region_name` when calling `get_availability_zone_performance`")  # noqa: E501
        # verify the required parameter 'availability_zone_name' is set
        if ('availability_zone_name' not in params or
                params['availability_zone_name'] is None):
            raise ValueError("Missing the required parameter `availability_zone_name` when calling `get_availability_zone_performance`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/regions/{region_name}/availability-zones/{availability_zone_name}/performance', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_availability_zone_space(self, region_name, availability_zone_name, **kwargs):  # noqa: E501
        """(Provider) Gets space metrics of a specific Availability Zone.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_availability_zone_space(region_name, availability_zone_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_availability_zone_space_with_http_info(region_name, availability_zone_name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_availability_zone_space_with_http_info(region_name, availability_zone_name, **kwargs)  # noqa: E501
            return data

    def get_availability_zone_space_with_http_info(self, region_name, availability_zone_name, **kwargs):  # noqa: E501
        """(Provider) Gets space metrics of a specific Availability Zone.  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_availability_zone_space" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'region_name' is set
        if ('region_name' not in params or
                params['region_name'] is None):
            raise ValueError("Missing the required parameter `region_name` when calling `get_availability_zone_space`")  # noqa: E501
        # verify the required parameter 'availability_zone_name' is set
        if ('availability_zone_name' not in params or
                params['availability_zone_name'] is None):
            raise ValueError("Missing the required parameter `availability_zone_name` when calling `get_availability_zone_space`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/regions/{region_name}/availability-zones/{availability_zone_name}/space', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
