...
class OperationsApi(object):
    ...
    def update_operation(self, body, id, **kwargs):  # noqa: E501
        """Updates a specific Operation.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_operation(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param OperationPatch body: (required)
        :param str id: The Operation ID (required)
        :param str x_request_id: The Request ID supplied with the request, used to perform operations idempotently.
        :param str authorization: Access token (in JWT format) required to use any API endpoint.
        :param str x_correlation_id: The Correlation ID provided will be added to log messages and can be used for support. The same Correlation ID may be used for separate requests, to track a higher level workflow.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_operation_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_operation_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_operation_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Updates a specific Operation.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_operation_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'id', 'x_request_id', 'authorization', 'x_correlation_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
